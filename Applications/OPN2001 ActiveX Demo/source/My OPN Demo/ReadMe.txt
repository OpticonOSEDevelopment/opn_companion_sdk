================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : My OPN Demo Project Overview
===============================================================================

The application wizard has created this My OPN Demo application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your My OPN Demo application.
...
My OPN Demo.h
    ...
    CMyOPNDemoApp application class.
...
res\My OPN Demo.ico
    ...
    icon is included by the main resource file My OPN Demo.rc.
...
My OPN DemoDlg.h, My OPN DemoDlg.cpp - the dialog
    These files contain your CMyOPNDemoDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in My OPN Demo.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CMyOPNDemoDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named My OPN Demo.pch and a precompiled types file named StdAfx.obj.

Resource.h
    This is the standard header file, which defines new resource IDs.
    Microsoft Visual C++ reads and updates this file.

My OPN Demo.manifest
